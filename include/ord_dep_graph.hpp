...
typedef std::map<AbsDependency, std::vector<const VectorClock*>> NodeContainerT;
typedef std::map<AbsDependency, std::vector<const VectorClock*>>::const_iterator NodeConstItT;
